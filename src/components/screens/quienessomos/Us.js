...
const Us = () => {
    ...
    return (
        <Row className='us d-flex flex-column-reverse flex-md-row bg-secondary px-0 mx-0 mb-5 p-md-5'>
            <Col className='textbox d-flex align-self-center px-4 py-5 pl-md-0 pr-md-4 py-md-0'>
                <Container className='p-0'>                   
                    <h2 className='title-section text-center text-white mb-3 m-0'>Quienes somos</h2>
