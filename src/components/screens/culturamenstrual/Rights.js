...
const Rights = () => {
    ...
    return (
        <Row className='rights mb-5 mx-0'>
            <Container fluid className='p-0'>
                <Row className='d-flex flex-column flex-md-row m-0'>
                            ...
                            <Accordion defaultActiveKey="0" className='accordion'>
                                ...
                                <Card className='card normal-text'>
                                    ...
                                    <Accordion.Collapse eventKey="2">
                                        <Card.Body>La falta de un lugar seguro o de la capacidad para manejar la higiene menstrual, así como la falta de medicamentos para tratar el dolor relacionado con la menstruación, pueden contribuir a elevar las tasas de ausentismo escolar y los deficientes resultados educativos. Algunos estudios han confirmado que cuando las niñas no pueden manejar adecuadamente la menstruación en la escuela, su asistencia escolar y su rendimiento se resienten.</Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                                <Card className='card normal-text'>
                                ...
                                <Card className='card normal-text'>
                                    ...
                                    <Accordion.Collapse eventKey="4">
                                        <Card.Body>Los estigmas y las normas relacionadas con la menstruación pueden reforzar las prácticas discriminatorias. Los obstáculos relacionados con la menstruación en la escuela, el trabajo, los servicios de salud y las actividades públicas también perpetúan las desigualdades de género.</Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                            </Accordion>
                        </Row>
