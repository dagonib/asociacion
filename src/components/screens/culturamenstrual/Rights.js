                ...
                <Row className='d-flex flex-column-reverse m-0'>
                    <Col className='d-flex flex-column px-3 py-5 px-0 bg-secondary'>
                        <Row className='d-flex justify-content-center mx-0'>
                            ...
                            <p className='normal-text text-white text-center mx-0 mx-sm-2 mt-3'>Hay una serie de derechos humanos universalmente aceptados que pueden ser socavados por el tratamiento que se presta a mujeres y niñas durante la menstruación. Estos son, entre otros:</p>
                        </Row>
