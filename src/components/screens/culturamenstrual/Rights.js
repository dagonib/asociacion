                            ...
                            <Accordion defaultActiveKey="0" className='accordion'>
                                ...
                                <Card className='card normal-text'>
                                    ...
                                    <Accordion.Collapse eventKey="2">
                                        <Card.Body className='card-body normal-text'>La falta de un lugar seguro o de la capacidad para manejar la higiene menstrual, así como la falta de medicamentos para tratar el dolor relacionado con la menstruación, pueden contribuir a elevar las tasas de ausentismo escolar y los deficientes resultados educativos. Algunos estudios han confirmado que cuando las niñas no pueden manejar adecuadamente la menstruación en la escuela, su asistencia escolar y su rendimiento se resienten.</Card.Body>
                                    </Accordion.Collapse>
                                </Card>
                                <Card className='card normal-text'>
