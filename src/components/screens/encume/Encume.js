        ...
        <Row className='encume d-flex flex-column flex-md-row align-items-stretch mx-0'>
            <Col xs={{ order: 'last' }} md={{ order: 'first' }} className='d-flex align-items-center py-5 px-0 px-sm-2 px-md-4 bg-secondary'>
                <Container>                   
                    ...
                    <p className='encume-text normal-text px-0 m-0'>En cada encuentro sentamos las bases para una definición de una nueva Cultura menstrual y una educación menstrual inclusiva, integral, sostenible y feminista.</p>
                    <Button 
