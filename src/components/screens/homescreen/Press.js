            ...
            <Container fluid className='d-flex flex-column flex-md-row align-items-stretch'>
                ...
                <Col md={8} className='p-0'>
                    <div className='mb-4'>
                        ...
                        <p className='small-text'>Artículo publicado por "Onada feminista" donde explican cómo fue el Encuentro virtual de salud menstrual el pasado 30 de mayo, con nuestras invitadas Mónica Richardson experta en Medicina Tradicional China, Ana de Ginevitex - Equilibrio Hormonal 100% natural y Ana Luisa Mesa de su proyecto Lunita Roja.</p>
                        <Button
                    ...
                    <div className='mb-4'>
                        ...
                        <p className='small-text'>Des que es va decretar l'estat d'alarma, moltes dones han tingut retards, dolors menstruals més forts i regles menys abundants, entre més canvis
